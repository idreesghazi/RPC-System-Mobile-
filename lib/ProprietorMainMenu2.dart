...
class ProprietorMainMenuScreen2 extends StatefulWidget {
  const ProprietorMainMenuScreen2({Key? key}) : super(key: key);

  @override
  State<ProprietorMainMenuScreen2> createState() => _ProprietorMainMenuScreen2State();
}

class _ProprietorMainMenuScreen2State extends State<ProprietorMainMenuScreen2> {
  @override
