...
import 'package:untitled/ProprietorComplaint.dart';
...
class ProprietorMainMenuScreen1 extends StatefulWidget {
  const ProprietorMainMenuScreen1({Key? key}) : super(key: key);

  @override
  State<ProprietorMainMenuScreen1> createState() => _ProprietorMainMenuScreen1State();
}

class _ProprietorMainMenuScreen1State extends State<ProprietorMainMenuScreen1> {
  @override
          ...
          child: Container(
            decoration: BoxDecoration(
                image: DecorationImage(
                    image: AssetImage("lib/img/ProprietorMainMenu.png"),
                    fit: BoxFit.cover
                )
            ),
            child: Container(
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              Text("House 40 - G15/1",style:TextStyle(fontSize: 18,fontFamily: "Abhaya Libre", fontWeight: FontWeight.bold, color: Colors.black)),
                              SizedBox(height: 5,),
                              Text("Owned",textAlign: TextAlign.left,style:TextStyle(fontSize: 18,fontFamily: "Abhaya Libre", fontWeight: FontWeight.bold, color: Color(0xff733AEB).withOpacity(0.51))),
