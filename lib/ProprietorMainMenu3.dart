...
import 'NavBar.dart';
import 'ProprietorComplaint.dart';
import 'login.dart';
import 'package:flutter/services.dart';


class ProprietorMainMenuScreen3 extends StatefulWidget {
  const ProprietorMainMenuScreen3({Key? key}) : super(key: key);

  @override
  State<ProprietorMainMenuScreen3> createState() => _ProprietorMainMenuScreen3State();
}

class _ProprietorMainMenuScreen3State extends State<ProprietorMainMenuScreen3> {
  @override
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              Text("House 33 - DHA",style:TextStyle(fontSize: 18,fontFamily: "Abhaya Libre", fontWeight: FontWeight.bold, color: Colors.black)),
                              SizedBox(height: 5,),
