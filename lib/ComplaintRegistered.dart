...
class ComplaintRegisteredScreen extends StatefulWidget {
  const ComplaintRegisteredScreen({Key? key}) : super(key: key);

  @override
  State<ComplaintRegisteredScreen> createState() => _ComplaintRegisteredScreenState();
}

class _ComplaintRegisteredScreenState extends State<ComplaintRegisteredScreen> {
  @override
